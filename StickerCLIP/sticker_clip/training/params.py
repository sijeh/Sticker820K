...
def parse_args():
    ...
    #     type=str,
    #     required=True,
    #     help="Path to the LMDB directory with train&valid data splits",
    # )
    # parser.add_argument(
    #     "--splits",
    #     choices=['sogou', 'qq', 'sogou&qq'],
    #     required=True,
    #     help="choice of ['sogou','qq','sogou&qq']",
    # )
    parser.add_argument(
        "--train-data",
        type=str,
    ...
    parser.add_argument("--num-workers", type=int, default=8, help="The number of workers for dataloader.")
    parser.add_argument(
        "--logs",
        type=str,
        default="./logs/",
    ...
    parser.add_argument("--report-training-batch-acc",
                        default=False,
                        action="store_true",
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        "The path of openai pretrained weight, used to initialize the image encoder, should be set to None if you do not use pretrained CLIP",
    )
    parser.add_argument(
        "--freeze-vision",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        "The path of bert pretrained weight, used to initialize the text encoder, should be set to None if you do not use pretrained BERT",
    )
    parser.add_argument(
        "--grad-checkpointing",
        default=False,
    ...
    parser.add_argument("--skip-aggregate",
                        default=False,
                        action="store_true",
